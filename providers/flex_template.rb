...
action :create do
  ...
  unless node['flex-template']['disabled'] or node['flex-template']['templates_disabled']
    begin
  ...
  unless node['flex-template']['disabled'] or node['flex-template']['files_disabled']
    begin
